...
const Members = () => {
  let members = useState(null);
  const [getMembers, setMembers] = useState(null);

  useEffect(async () => {
    members = await window.api.viewMembers();
    setMembers(members);
  }, getMembers);
    ...
    <Wrapper>
      ...
      <div className="row members-list">
        <div className="col-12">
          ...
          <div className="row members-list__entries">
            <div className="col">Juan Doe</div>
            <div className="col">Male</div>
